...
const {
    addRentalItems,getOrderById , getMyOrders ,getMyCart , updateOrderToPaid, updateOrderToDelivered, updateOrderToReturned,getOrders,razorPay
...
router.route('/:id/pay').post(tkCheck, razorPay)
router.route('/:id/paid').put(tkCheck, updateOrderToPaid)
